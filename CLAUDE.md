...
3. **Multi-size (6×6 / 9×9 / 16×16)** — **6×6 + 9×9 SHIPPED (all 3 layers); 16×16 deferred.** Every variant (classic/X/jigsaw/killer) is now playable at 6×6 and 9×9. Spec/plans in `docs/superpowers/{specs,plans}/2026-05-31-*`.
